package com.example.sukbak.controller.lghController;
...
import com.example.sukbak.service.lghService.MypageService;
...
public class MypageController {
	...
	public String putMyReview(GunJoin gj, Model model, @RequestParam MultipartFile[] files,
		...
		// 4. metaPath -> C:\Users\\user\git\sukbak\bin\main\static\img\review\ 나온 값을 yml에 주입함.
		...
		//String rootPath = ("C:\\Users\\user\\git\\sukbak\\bin\\main\\static");
		...
		for (MultipartFile file : files) {
			if (file != null && !file.isEmpty()) {
				...
				// rootPath = C:\Users\\user\git\sukbak\bin\main\static
